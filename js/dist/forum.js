...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('datlechin/flarum-chatgpt', function () {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_PostUser__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'view', function (view) {
    var user = this.attrs.post.user();
    if (!user || flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('chatGptUserPromptId') !== user.id()) return;
    view.children.push(m("div", {
      className: "UserPromo-badge"
    }, m("div", {
      className: "badge"
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('chatGptBadgeText'))));
  });
});
